...
/*   Updated: 2024/06/25 11:18:24 by edecorce         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	free_global_arg(int is_global_arg, char **map)
{
	int	i;
...
int	main(int argc, char **argv)
{
	...
	ft_lstclear(&a);
	ft_lstclear(&b);
	free_global_arg(is_global_arg, argv);
	return (0);
}
